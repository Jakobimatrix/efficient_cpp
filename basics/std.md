...
**Try to avoid std::bind. The compiler is able to optimize your code far better, if you use a lambda expression instead.**
...
- [optimize usage of std::vector](https://www.youtube-nocookie.com/embed/HcESuwmlHEY?rel=0&start=67&end=540) *~8 min.*
